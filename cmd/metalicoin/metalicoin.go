...
type Config struct {
	...
	// Data directory holds app data -- defaults to ~/.metallicoin
...
func (c *Config) register() {
	...
	flag.StringVar(&c.DataDirectory, "data-dir", c.DataDirectory, "directory to store app data (defaults to ~/.metallicoin)")
	flag.StringVar(&c.DBPath, "db-path", c.DBPath, "path of database file (defaults to ~/.metallicoin/data.db)")
	...
	flag.BoolVar(&c.RunMaster, "master", false, "run the daemon as blockchain master server")
	...
	flag.StringVar(&c.WalletDirectory, "wallet-dir", c.WalletDirectory, "location of the wallet files. Defaults to ~/.metallicoin/wallet/")
...
var devConfig = Config{
	...
	PeerListURL:            "https://downloads.metalicoin.net/blockchain/peers.txt",
...
func InitTransaction() coin.Transaction {
	...
	output := cipher.MustSHA256FromHex("71751c2071b2e017ca2a3cbe3fdeb282128fd229a4de110123af4c092c61c1e1")
	tx.PushInput(output)
	...
	sig := "84bacdeae1beb5b454f23eb9a69b3cf7c4d087f31d12e2162159adc5220b753a6546a431157f322141467598f8389192162e4e8a7a6dd5d6070c2231fc14dd8800"
